...
const Features = () => {
  ...
  return (
    <section>
      {/* Section with native id for scrolling */}
          ...
          {features.map(({ id, icon, caption, title, text, button }) => (
            ...
            >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition duration-300"
              >
                <img src={button.icon} alt="Icon" className="w-5 h-5" />
                {button.title}
              </button>
            </div>
          ))}
